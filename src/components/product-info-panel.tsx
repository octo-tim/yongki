  ...
  return (
    <div className="space-y-3 text-sm">
      ...
      <div className="rounded-md border bg-muted/30 p-2.5 text-xs">
        ...
        <div className="mt-1 flex justify-between"><span className="text-muted-foreground">판매 전체금액</span><span className="font-semibold text-blue-700">{fmtUnit(salesTotal)} {salesCcy}</span></div>
